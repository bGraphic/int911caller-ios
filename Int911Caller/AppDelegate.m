...
- (void) loadEmergencyNumbers {
    ...
    [[[tabBarController.viewControllers objectAtIndex:0] tabBarItem] setTitle:NSLocalizedString(@"tab_bar_local", nil)];
    [[[tabBarController.viewControllers objectAtIndex:1] tabBarItem] setTitle:NSLocalizedString(@"tab_bar_directory", nil)];
}
